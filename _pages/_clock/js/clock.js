...
Clock.prototype.create = function () {
    ...
    this.hours = clock.rect( (this.x + 30), (this.y + 10), 3, 20).attr({fill: "#fff"});  

    this.minutes = clock.rect( (this.x + 31), (this.y + 10), 3, 20).attr({fill: "#fff"});
...
ClockGroup.prototype.setCustom = function(arr) {
    for (var b = 0; b < 6; b++) {
        this.groups[b].setTime( arr[b] );
    }
}
